...
const CONTINUE_INSTRUCTION =
  '直前の出力は出力上限に達して途中で切れている。切れた箇所の直後から、自然につながるように本文を書き続けよ。地の文は常体(だ・である調)を維持し、です・ます調へ変えないこと。小見出しと重要語の太字を含むMarkdown形式も維持すること。すでに書いた部分を繰り返したり要約したりしないこと。「続き」などの前置きや説明文は一切付けず、小説本文のみを出力すること。';
